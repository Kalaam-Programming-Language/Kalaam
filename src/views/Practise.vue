...
<li style="margin:0px">
  ...
  <span v-if="!this.$store.state.LearningOn"><li >Learning Mode</li></span> 
   <span v-if="this.$store.state.LearningOn"><li style="color:green"   >Learning Mode</li></span> 
    ...
    <div v-if="this.$store.state.LearningOn" class="PractiseMode Learning" id="compiler">
      <div id="textarea">
        <no-ssr placeholder="...">
          <codemirror
            id="codearea"
        ...
        <button class="RunLinebyLineBtn" id="subm" @click="RunLinebyLine()">Run LinebyLine</button>
        <button class="ClearBtn" id="subm" @click="Clear()">Clear</button>
    ...
    <div v-if="this.$store.state.PractiseOn" class="PractiseMode" id="compiler">
      <div id="textarea">
        ...
        <div id="ControlPanel">
          <button class="RunBtn" id="subm" @click="RUN()">RUN</button>
          <button id="subm" @click="Add('प्रिंट()')">प्रिंट</button>
          <button id="subm" @click="Add('इनपुट()')">इनपुट</button>
